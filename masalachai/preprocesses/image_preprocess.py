...
def random_rotation(x, 
    ...
    return rotation(x, g, row_index=row_index, col_index=col_index, channel_index=channel_index, fill_mode=fill_mode, cval=cval)
...
def random_shift(x, 
    ...
    return shift(x, wg, hg, row_index=row_index, col_index=col_index, channel_index=channel_index, fill_mode=fill_mode, cval=cval)  
...
def random_shear(x, 
    ...
    return shear(x, s, row_index=row_index, col_index=col_index, channel_index=channel_index, fill_mode=fill_mode, cval=cval)  
...
def random_zoom(x, 
    ...
    return zoom(x, (zx, zy), row_index=row_index, col_index=col_index, channel_index=channel_index, fill_mode=fill_mode, cval=cval)  
