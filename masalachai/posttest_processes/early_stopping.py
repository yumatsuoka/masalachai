...
class EarlyStopping(SnapshotBest):
    ...
    def __init__(self, model, filename, observed='loss', patience=1, imporovement=0.995, interval=10, best_only=False):
        super(EarlyStopping, self).__init__(
                model, filename, observed=observed, patience=patience, best_only=best_only)
